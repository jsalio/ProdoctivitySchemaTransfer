...
export class ConnectionStatusService {
  private credentialsCloud = computed(() =>
    this.storage.getValue<Credentials>('Credentials_V6_Cloud'),
  );
  private credentialsFluency = computed(() =>
    this.storage.getValue<Credentials>('Credentials_V5_V5'),
  );
