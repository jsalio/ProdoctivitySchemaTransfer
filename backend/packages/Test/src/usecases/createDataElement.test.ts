...
import { AppCodeError, Credentials, CreateDataElement, IRequest, IStore, DataElement, CreateDataElementRequest } from "@schematransfer/core"
...
describe("CreateDataElement", () => {
    ...
    describe("execute", () => {
        it("should create and return data element when store operation is successful", async () => {
            ...
            expect(mockStore.createDataElement).toHaveBeenCalledWith(
                mockCredentials,
                {
                    name: elementName,
                    documentTypeId: "",
