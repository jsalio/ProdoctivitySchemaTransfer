...
import { AppCodeError, Credentials, GetDocumentTypeSchema, IRequest, IStore, SchemaDocumentType, GetDocumentTypeSchemaRequest } from "@schematransfer/core"
...
describe("GetDocumentTypeSchema", () => {
    ...
    describe("execute", () => {
        it("should return document type schema when store operation is successful", async () => {
            ...
            expect(mockStore.getDocumentTypeSchema).toHaveBeenCalledWith(mockCredentials, mockDocumentTypeId);
        });
